...
export default function RotatePdfPage(): JSX.Element {
  ...
  return (
 <div className="text-slate-900 dark:text-slate-100 flex flex-col items-center antialiased selection:bg-slate-900 selection:text-white dark:selection:bg-slate-100 dark:selection:text-slate-900">
      <div className="max-w-5xl w-full space-y-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl shadow-2xl backdrop-blur-xl">
