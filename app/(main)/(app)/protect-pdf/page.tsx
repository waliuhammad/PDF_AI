            ...
            {!file ? (
                ...
                <div className="max-w-xl w-full bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800/80 rounded-3xl p-8 shadow-2xl space-y-6">
                    ...
                    <form onSubmit={handleProtect} className="space-y-6">
                        <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-[#0d1322] border border-slate-200 dark:border-slate-700/80">
                        ...
                        {numPages > 0 && (
                            <div className="space-y-2 bg-slate-50 dark:bg-[#0d1322] p-4 rounded-xl border border-slate-200 dark:border-slate-700/80">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-slate-50 dark:bg-[#0d1322] border border-slate-300 dark:border-slate-700/80 rounded-xl px-4 py-3 pr-20 text-slate-900 dark:text-slate-100 focus:outline-none focus:border-purple-900 dark:focus:border-cyan-500 text-sm"
                                    />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 dark:bg-[#0d1322] border border-slate-300 dark:border-slate-700/80 rounded-xl px-4 py-3 text-slate-900 dark:text-slate-100 focus:outline-none focus:border-purple-900 dark:focus:border-cyan-500 text-sm"
                                />
                        ...
                        <button
                            ...
                            className="w-full bg-slate-900 dark:bg-[#0d1322] border border-slate-900 dark:border-slate-700/80 hover:bg-slate-800 dark:hover:bg-[#111827] text-white font-semibold py-3.5 px-4 rounded-xl transition-all shadow-lg disabled:opacity-50 text-sm tracking-wide flex items-center justify-center gap-2"
                        >
                            {processing ? (
                                "Protecting PDF..."
                            ) : done ? (
